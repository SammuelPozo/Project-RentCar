...
namespace RentCar {
    ...
    public partial class RentCarDBDataSet3 : global::System.Data.DataSet {
        ...
        public partial class ModeloDataTable : global::System.Data.TypedTableBase<ModeloRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ModeloRow AddModeloRow(int Id_marca, string Descripcion, bool Estado) {
...
namespace RentCar.RentCarDBDataSet3TableAdapters {
    ...
    public partial class ModeloTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Modelo] WHERE (([idModelo] = @Original_idModelo) AND ([Id_marc" +
                "a] = @Original_Id_marca) AND ([Descripcion] = @Original_Descripcion) AND ([Estad" +
                "o] = @Original_Estado))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Modelo] SET [Id_marca] = @Id_marca, [Descripcion] = @Descripcion, [Estado] = @Estado WHERE (([idModelo] = @Original_idModelo) AND ([Id_marca] = @Original_Id_marca) AND ([Descripcion] = @Original_Descripcion) AND ([Estado] = @Original_Estado));
SELECT idModelo, Id_marca, Descripcion, Estado FROM Modelo WHERE (idModelo = @idModelo)";
        ...
        public virtual int Fill(RentCarDBDataSet3.ModeloDataTable dataTable) {
        ...
        public virtual RentCarDBDataSet3.ModeloDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RentCarDBDataSet3.ModeloDataTable dataTable = new RentCarDBDataSet3.ModeloDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RentCarDBDataSet3.ModeloDataTable dataTable) {
        ...
        public virtual int Delete(int Original_idModelo, int Original_Id_marca, string Original_Descripcion, bool Original_Estado) {
        ...
        public virtual int Insert(int Id_marca, string Descripcion, bool Estado) {
        ...
        public virtual int Update(int Id_marca, string Descripcion, bool Estado, int Original_idModelo, int Original_Id_marca, string Original_Descripcion, bool Original_Estado, int idModelo) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Id_marca, string Descripcion, bool Estado, int Original_idModelo, int Original_Id_marca, string Original_Descripcion, bool Original_Estado) {
